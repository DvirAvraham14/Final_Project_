...
void GameScreen::createObj() {
	...
	m_objects.push_back(std::make_unique<Ground>(m_level, m_map.getRoad(), m_world));
	...
	m_enemies.push_back(std::make_unique<Truck>(res::TEXTURE::Truck, m_world, sf::Vector2f(100, 550),
